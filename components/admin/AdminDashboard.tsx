  ...
  const calculateTotalMargin = () => {
    ...
    transactions.forEach(t => {
      t.items.forEach(item => {
        // Find current purchase price for this item (simplified: uses current product cost)
...
// Helper for the chart to avoid type complexity in main render
