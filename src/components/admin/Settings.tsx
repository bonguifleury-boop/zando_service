...
import { Save, Download, Upload, Store, Database, Image as ImageIcon, Trash2 } from 'lucide-react';
                 ...
                 <div className="space-y-8">
                     ...
                     <div className="bg-amber-50 border border-amber-200 rounded-lg p-6">
                        ...
                        <p className="text-amber-700 text-sm mb-4">
                            ...
                            <strong className="block mt-1">ATTENTION : Cette action remplacera toutes les données actuelles par celles du fichier.</strong>
                        </p>
                     ...
                     {onResetDatabase && (
                        <div className="bg-red-50 border border-red-200 rounded-lg p-6 mt-8">
                            <h3 className="text-lg font-bold text-red-900 mb-2 flex items-center"><Trash2 className="mr-2" size={20}/> Zone de Danger</h3>
                            <p className="text-red-700 text-sm mb-4">
                                Vous pouvez effacer complètement la base de données Firebase pour recommencer à zéro.
                            </p>
                            <button onClick={onResetDatabase} className="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 flex items-center">
                                <Trash2 size={18} className="mr-2" /> Réinitialiser la Base de Données
                            </button>
                        </div>
                     )}
                 </div>
