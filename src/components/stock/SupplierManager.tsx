  ...
  const handleSave = async () => {
    ...
    try {
        if (editingSupplier) {
          ...
          // On passe un ID temporaire, mais c'est le serveur qui générera l'UUID final
        ...
        if (success) {
            ...
            // L'erreur est généralement gérée par App.tsx qui fait un alert, 
            // mais on garde le modal ouvert.
            setErrorMsg("Une erreur est survenue lors de l'enregistrement. Vérifiez la console ou les permissions.");
        }
    } catch (e) {
        console.error(e);
